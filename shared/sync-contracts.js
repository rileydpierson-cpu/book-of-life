...
function normalizeDesktopSyncSettings(value = {}) {
  ...
  return {
    ...
    desktopHostUrl: String(settings.desktopHostUrl || '').trim(),
    hostRelayToken: String(settings.hostRelayToken || '').trim(),
    hostRelayTokenExpiresAt: String(settings.hostRelayTokenExpiresAt || '').trim(),
    mediaFolders,
    hostAvailability,
    storageMode,
    entryImportMode,
